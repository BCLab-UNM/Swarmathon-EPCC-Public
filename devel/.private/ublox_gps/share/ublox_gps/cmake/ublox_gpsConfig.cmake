...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/timeinvestor2/SwarmBaseCode-ROS/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/timeinvestor2/SwarmBaseCode-ROS/devel/.private/ublox_gps)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/timeinvestor2/SwarmBaseCode-ROS/install)
...
if(NOT "/home/timeinvestor2/SwarmBaseCode-ROS/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/timeinvestor2/SwarmBaseCode-ROS/src/ublox/ublox_gps/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>, Gareth Cross <gcross.code@icloud.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/timeinvestor2/SwarmBaseCode-ROS/src/ublox/ublox_gps/${idir}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>, Gareth Cross <gcross.code@icloud.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/timeinvestor2/SwarmBaseCode-ROS/devel/.private/ublox_gps/lib;/home/timeinvestor2/SwarmBaseCode-ROS/devel/lib;/opt/ros/kinetic/lib)
