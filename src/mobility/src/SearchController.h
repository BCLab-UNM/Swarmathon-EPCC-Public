...
class SearchController {
  ...
  public:
    ...
    //epcc EV original instruction 

    //geometry_msgs::Pose2D search(geometry_msgs::Pose2D currentLocation);

    geometry_msgs::Pose2D search(geometry_msgs::Pose2D currentLocation, int NUMpublishedNameEPCC, bool WeAreInPrelimCompetitionEPCC, int ModeOfSearchEPCC);
