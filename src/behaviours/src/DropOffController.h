...
private:
  ...
  const int centerTagThreshold = 9; //EPCC// original 8, changed to 10 because we want to assure NSEW entrance
  //EPCC// approach to nest line and avoid corners or approaching at oblique angles
